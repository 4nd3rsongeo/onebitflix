...
Course_1.Course.belongsToMany(User_1.User, { through: Favorite_1.Favorite }); //relação muitos pra muitos através do model Favorite
...
Course_1.Course.hasMany(Like_1.Like, { as: 'LikesCourses', foreignKey: 'course_id' });
...
// Like.belongsTo(User)
User_1.User.belongsToMany(Course_1.Course, { through: Favorite_1.Favorite }); //relação muitos pra muitos através do model Favorite
...
User_1.User.hasMany(Like_1.Like, { as: 'LikesCourses', foreignKey: 'user_id' });
