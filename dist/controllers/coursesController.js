...
exports.coursesController = {
    ...
    show: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const liked = yield likeService_1.likeService.isLiked(userId, +courseId);
            const favorited = yield favoriteService_1.favoriteService.isFavorited(userId, +courseId);
